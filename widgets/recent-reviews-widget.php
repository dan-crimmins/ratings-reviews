...
class Recent_Reviews_Widget extends WP_Widget {
     ...
     * @var string [REQUIRED]
     */
    var $widget_name = 'Recent Reviews Widget';
     ...
     */
    var $id_base = 'recent_reviews_widget';
     ...
     * @var string [OPTIONAL]
     */
    private $description = 'Displays recent reviews';
    ...
    public function widget( $args, $instance ){
        ...
        extract($instance);
       	...
       	$reviews = RR_Recent_Reviews::factory()
    ...
    public function update($new_instance, $old_instance){
        ...
        if((isset($instance['recent_reviews_num']) && ! count(trim($instance['recent_reviews_num']))) || (! isset($instance['recent_reviews_num']))) {
        	
        	$instance['recent_reviews_num'] = 3;
        }
    ...
    public function form($instance){
        ...
        $defaults = array('recent_reviews_title' => 'Recent Reviews', 'recent_reviews_num' => '3');
        ...
        $fields = array(
            array(
                'field_id' => 'recent_reviews_title',
                'type' => 'text',
                'label' => 'Enter Title'
            ),
            array(
                'field_id' => 'recent_reviews_num',
                'type' => 'select',
...
Recent_Reviews_Widget::register_widget();